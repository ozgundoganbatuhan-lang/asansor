        ...
        <aside style={{
          ...
          <div style={{ padding:"18px 16px 14px", display:"flex", alignItems:"center",
            ...
            <div style={{ flex:1, minWidth:0 }}>
              ...
              <div style={{ fontSize:9.5, fontWeight:500, color:C.text,
                letterSpacing:"0.5px", textTransform:"uppercase", marginTop:3 }}>
                Asansör Operasyon
              </div>
            </div>
            <span style={{ background:C.hover, color:C.textA, fontSize:9,
          ...
          <div style={{ padding:"10px 12px", borderBottom:`1px solid ${C.border}`, flexShrink:0 }}>
            <div style={{ display:"flex", alignItems:"center", gap:8, background:C.hover,
              ...
              <kbd style={{ fontSize:10, color:C.text, background:"rgba(255,255,255,.07)",
          ...
          <nav style={{ flex:1, overflowY:"auto", scrollbarWidth:"none" as const, paddingBottom:8 }}>
            {NAV.map(group => (
              <div key={group.group}>
                <div style={{ fontSize:9.5, fontWeight:600, color:C.text,
          ...
          <div style={{ flexShrink:0, borderTop:`1px solid ${C.border}` }}>
            ...
            <div style={{ padding:"10px 12px", display:"flex", alignItems:"center", gap:9 }}>
              ...
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontSize:12, fontWeight:600, color:C.textA,
              ...
              <div style={{ display:"flex", gap:4 }}>
                <Link href="/app/settings" title="Ayarlar"
                  style={{ color:C.text, padding:4, borderRadius:4,
                ...
                <button onClick={logout} title="Çıkış"
                  style={{ background:"none", border:"none", cursor:"pointer",
                    color:C.text, padding:4, borderRadius:4,
            ...
            <div style={{ display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
              {!mob && (
                <div style={{ display:"flex", alignItems:"center", gap:6,
                  ...
                  <span style={{ fontSize:12.5, color:"#9ca3af", flex:1 }}>Hızlı ara</span>
