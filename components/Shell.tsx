...
const SECTION_MAP: Record<string, string> = {
  "/app/dashboard": "ASTEK",
  "/app/work-orders": "OPERASYON",
  "/app/customers": "PORTFÖY",
  "/app/assets": "SERVİSİM FİLO",
  "/app/maintenance-plans": "SAHA",
  "/app/inspections": "SAHA",
  "/app/technicians": "SAHA",
  "/app/calendar": "SAHA",
  "/app/contracts": "FİNANS",
  "/app/invoices": "FİNANS",
  "/app/stock": "FİNANS",
  "/app/reports": "FİNANS",
  "/app/settings": "SİSTEM",
...
function getSection(pathname: string) {
  const match = Object.keys(SECTION_MAP).find(k => pathname === k || pathname.startsWith(k + "/"));
  return match ? SECTION_MAP[match] : "ASTEK";
}
    ...
    <div style={{ minHeight: "100vh", background: "var(--background)", display: "flex",
      ...
      <aside style={{
        ...
        <div style={{ padding: "18px 16px 14px", display: "flex", alignItems: "center",
          gap: 10, flexShrink: 0, borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
          <div style={{ width: 34, height: 34, background: "linear-gradient(135deg,#2563eb,#1d4ed8)",
            borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 15, fontWeight: 800, color: "#fff", flexShrink: 0, letterSpacing: "-0.03em" }}>
            S
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 14, fontWeight: 800, color: "#3b82f6", letterSpacing: "-0.03em", lineHeight: 1 }}>
              Servisim
            </div>
          ...
          <span style={{ background: "rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.5)",
        ...
        <div style={{ padding: "10px 12px", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
          <div style={{ width: "100%", background: "rgba(255,255,255,0.05)",
            ...
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.25)", flex: 1 }}>Ara...</span>
            <kbd style={{ fontSize: 9.5, color: "rgba(255,255,255,0.2)",
        ...
        <div style={{ padding: "10px 12px 4px" }}>
          <Link href="/technician" style={{
            ...
            <div style={{ width: 30, height: 30, borderRadius: 7,
              background: "rgba(37,99,235,0.35)", display: "flex",
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 11.5, fontWeight: 700, color: "#93c5fd", lineHeight: 1.2 }}>Teknisyen Portalı</div>
        ...
        <div style={{ flexShrink: 0, borderTop: "1px solid rgba(255,255,255,0.04)" }}>
          ...
          <div style={{ margin: "12px 12px 4px", background: "rgba(255,255,255,0.04)",
            ...
            <div style={{ display: "flex", justifyContent: "space-between",
              ...
              <span style={{ color: "rgba(255,255,255,0.7)", fontWeight: 500 }}>Deneme süresi</span>
              <span style={{ color: "rgba(255,255,255,0.35)" }}>8 gün kaldı</span>
            </div>
            ...
            <div style={{ display: "flex", gap: 2 }}>
              <Link href="/app/settings"
                style={{ background: "none", border: "none", cursor: "pointer",
                  color: "rgba(255,255,255,0.28)", padding: "5px", borderRadius: 6,
              ...
              <button onClick={logout}
                style={{ background: "none", border: "none", cursor: "pointer",
                  color: "rgba(255,255,255,0.28)", padding: "5px", borderRadius: 6, display: "flex" }}
                title="Çıkış">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 9.5, fontWeight: 600, textTransform: "uppercase",
                letterSpacing: "0.5px", color: "#9ca3af", marginBottom: 1 }}>
                {section}
              </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            {!isMob && (
              <div style={{ display: "flex", alignItems: "center", gap: 6,
                ...
                padding: "6px 12px", cursor: "pointer", minWidth: 160 }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/>
                </svg>
                <span style={{ fontSize: 12, color: "#6b7280" }}>Hızlı ara</span>
                <kbd style={{ fontSize: 10, color: "#9ca3af", background: "#e5e7eb",
                  borderRadius: 3, padding: "1px 5px", fontFamily: "monospace", marginLeft: "auto" }}>⌘K</kbd>
              </div>
            )}
