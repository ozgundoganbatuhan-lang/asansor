    ...
    <div style={{ minHeight:"100vh", background:"#0a0f1e", display:"flex", alignItems:"center", justifyContent:"center", padding:"24px", fontFamily:"'DM Sans', sans-serif" }}>
      ...
      <div style={{ width:"100%", maxWidth:420 }}>
        ...
        <div style={{ background:"rgba(255,255,255,0.03)", border:"1px solid rgba(255,255,255,0.08)", borderRadius:20, padding:36 }}>
          <h1 style={{ color:"white", fontSize:22, fontWeight:800, marginBottom:28 }}>Giriş Yapın</h1>
          <form onSubmit={onSubmit} style={{ display:"flex", flexDirection:"column", gap:16 }}>
            <div>
              <label style={{ display:"block", color:"#94a3b8", fontSize:13, fontWeight:600, marginBottom:6 }}>E-posta <span style={{ color:"#3b82f6" }}>*</span></label>
              <input style={inp} value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder="ali@firmaniz.com" required autoFocus />
            </div>
            <div>
              <label style={{ display:"block", color:"#94a3b8", fontSize:13, fontWeight:600, marginBottom:6 }}>Şifre <span style={{ color:"#3b82f6" }}>*</span></label>
        ...
        <div style={{ textAlign:"center", marginTop:20, color:"#475569", fontSize:14 }}>
          Hesabınız yok mu?{" "}
          <Link href="/auth/register" style={{ color:"#60a5fa", fontWeight:700, textDecoration:"none" }}>Ücretsiz Başlayın</Link>
        </div>
      </div>
    </div>
  );
