    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        <div>
          ...
          <h1 style={{ fontSize: 26, fontWeight: 700, color: "#111827", letterSpacing: "-0.5px", margin: 0 }}>Periyodik Kontrol Takibi</h1>
          <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>TSE / A Tipi Muayene Kuruluşu yıllık periyodik kontrolleri</p>
        </div>
