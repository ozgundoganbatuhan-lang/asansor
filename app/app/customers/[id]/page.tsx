...
type Customer = {
  ...
  taxId?: string | null; identityNo?: string | null; notes?: string | null;
};
type Asset = {
        ...
        <div>
          <div className="rounded-2xl border border-gray-200 bg-white shadow-sm p-5">
            ...
            <dl className="space-y-3">
              ...
              {customer.identityNo && <div><dt className="text-xs text-gray-400">TC Kimlik No</dt><dd className="font-mono text-sm text-gray-700 mt-0.5">{customer.identityNo}</dd></div>}
